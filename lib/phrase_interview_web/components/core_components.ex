defmodule PhraseInterviewWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhraseInterviewWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhraseInterviewWeb.Gettext, "errors", msg, opts)
    end
  end
